...
export const Route = createFileRoute("/app/dav")({
  head: () => ({ meta: [{ title: "Orçamentos (DAV) — PREMIUM GARDEN" }] }),
  component: DAVList,
});
...
function DAVList() {
  ...
  const handleShareWhatsApp = async (dav: any) => {
    try {
      ...
      console.error(err);
      toast.error("Erro ao gerar PDF do WhatsApp: " + err.message);
    }
  };
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="flex flex-col gap-2 pt-6 border-t">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Download className="mr-2 h-4 w-4 text-primary" /> Baixar PDF
                </Button>
