      ...
      <Dialog open={openSuccessModal} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col gap-3 py-4">
            ...
            <Button 
              className="w-full justify-start text-white bg-emerald-600 hover:bg-emerald-700"
              onClick={async () => {
            ...
            {savedVendaId && (
              <Button variant="outline" className="w-full justify-start" asChild>
                <a href={`/orcamento/${savedVendaId}`} target="_blank" rel="noreferrer">
                  <Eye className="mr-2 h-4 w-4" /> Visualizar / Imprimir Orçamento
                </a>
              </Button>
            )}
            <Button variant="outline" className="w-full justify-start" asChild>
